...
export default function HomeAbout() {
    ...
    return (
        <div className="container flex w-full relative min-h-screen justify-center items-center text-dark-primary">

            <div className=" flex flex-row justify-center items-center gap-x-24 h-full w-3/4">

                <SlideUpTitle className="text-9xl w-5/12 text-dark-background" >
